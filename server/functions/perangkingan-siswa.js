import { getNilaiAkhirAlternatif } from "./perhitungan-siswa.js";
...
export async function getRankingAlternatif(id_user) {
...
export async function getDataPerangkingan(id_user) {
  const ranking = await getRankingAlternatif(id_user);
